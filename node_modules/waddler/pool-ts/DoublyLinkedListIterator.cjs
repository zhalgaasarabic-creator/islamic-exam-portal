...
var DoublyLinkedListIterator_exports = {};
__export(DoublyLinkedListIterator_exports, {
  DoublyLinkedListIterator: () => DoublyLinkedListIterator
});
module.exports = __toCommonJS(DoublyLinkedListIterator_exports);
class DoublyLinkedListIterator {
   ...
   */
  constructor(doublyLinkedList, reverse = false) {
...
//# sourceMappingURL=DoublyLinkedListIterator.cjs.map