 ...
 */
declare class Queue<T> extends Deque<ResourceRequest<T>> {
    /**
     ...
     */
    push(resourceRequest: ResourceRequest<T>): void;
    _createTimeoutRejectionHandler(node: Node): (reason: any) => void;
}
