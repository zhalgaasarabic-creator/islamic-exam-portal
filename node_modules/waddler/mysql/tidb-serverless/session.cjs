...
__export(session_exports, {
  TidbServerlessSQLTemplate: () => TidbServerlessSQLTemplate
});
...
class TidbServerlessSQLTemplate extends import_sql_template.SQLTemplate {
